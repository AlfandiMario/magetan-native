...
if (!isset($_SESSION['user'])) {
    ...
    $sql = "SELECT * FROM alat_desi ORDER BY ID DESC LIMIT 5";
    $result = $conn->query($sql);

    //Chart
    $sqlChart = "SELECT date(tgl) as tgl, AVG(suhu) as suhu FROM alat_desi GROUP BY DATE_FORMAT(tgl, '%Y%m%d') 
...
<div class="page-header">
    <h1 class="page-title">Detail Level Suhu</h1>
...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Level Suhu Terakhir</h3>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Rata-rata Suhu Harian</h3>
            </div>
            <div class="card-body">
